...
# Display the data
Data_64_Subjects_0_48_Hours[c(1:7),c(1:7)] # show first 7 rows

# Display the dimensions (rows columns)
(dim(Data_64_Subjects_0_48_Hours))

## Dividing data set into train (70%) and test (30%) using createDataPartition function of caret package
set.seed(1234)
index_Train <- createDataPartition(y = Data_64_Subjects_0_48_Hours$Label, 
...
save(RF_train1, file = "RF_train1_64_sub_0_48_Hours.rda")

# Important Genes
(varImp(RF_train1))

# Save the results of trained model in a file
RF_train_64_sub_0_48_Hours_VarIMP_1 <- varImp(RF_train1)
write.table(RF_train_64_sub_0_48_Hours_VarIMP_1$importance, file = "RF_train_64_sub_0_48_Hours_VarIMP_1.tsv", sep = "\t")
