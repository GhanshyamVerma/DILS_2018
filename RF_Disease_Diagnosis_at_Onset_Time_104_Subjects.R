...
set.seed(1234)
index_Train <- createDataPartition(y = All_104_Subjects_0_Onset_Avg_Onset$Label, 
                                   p = 0.78, list = FALSE)
...
save(RF_train1, file = "RF_train1_104_sub_0_AvgOnset.rda")

# Important Genes
(varImp(RF_train1))

# Save the results (varible/gene importance) of trained model in a file
RF_train_104_sub_0_AvgOnset_VarIMP_1 <- varImp(RF_train1)
write.table(RF_train_104_sub_0_AvgOnset_VarIMP_1$importance, file = "RF_train_104_sub_0_AvgOnset_VarIMP_1.tsv", sep = "\t")
